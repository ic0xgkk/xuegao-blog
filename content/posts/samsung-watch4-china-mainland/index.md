...
- /posts/1931
- /archives/1931
- /samsung-watch4-china-mainland
categories:
- 玩机
date: 2021-10-10 17:30:21+08:00
draft: false
tags:
- Android
...
* 使用冰箱或者钛备份等应用，冻结Google Play服务和商店，记得是两个应用![apps](./cb9f7ba65d5d249138de24e03b9f890.webp)
...
![wearable](./b46767165f16b42e08add6a3ff3760d.webp)
...
* 打开你的三星健康APP，进入`侧边栏->设置->关于三星健康`，不停点击版本号处，即可出现一个Set按钮。在你的手机上可能不会显示第一个按钮，我们只需要点进去Set即可![dev_mode](./ea57301f8f39073c988695ea4ee2d60.webp)
* 进入Set后，分别按照如下几个步骤，点上对应的设置
* 设置区域为CN。印象里首次设置只显示了一个，仅设置一个为CN也可以![set_1](./3157654662345e1917c697f018119e8.webp)
* 按照如图分别设置为`DEV`和`on`![set_2](./737687b9feb5aa420a3106799d451db.jpg)![set_3](./d3b7d18cda7a71fcd125ca1c7405095.webp)
* 返回之后，提示强制停止程序，以生效刚刚的改动![back](./3d349d8c05c99f53788a2bcac2943f0.webp)
* 然后就OK啦

在完成这个操作之后，我们再次进入APP，即可看到数据已经同步出来了。由于我提前已经安装了心电图和血压计[^1]，因此数据已经一并完成同步并显示出来了。再看其他的运动数据，都已经同步成功

![ok](./523736d8e0daac98b6fd01b3dac5254.webp)
...
* 进入`Samsung Health Monitor`中，打开数据权限![data_1](./812cd1f0d559dfd62266886b0d26caf.jpg)![data_2](./af161de5d268004d2abceffab803da5.jpg)![data_3](./57111ef08199576d1a3f212e02fe1e7.webp)
* 进入`三星健康`中，打开数据权限![data_4](./4d5ecf18ff50a66c7b83169784033af.png)![data_5](./e1827b0548a99a91b3944b99df81722.jpg)![data_6](./c11d2bd9bd06f977406f466f0e5f45f.webp)
