...
- /posts/1952
- /archives/1952
- /routeros-openwrt-bypass-router-home-network
categories:
- 搞网络
- 玩机
date: 2022-09-10 11:47:23+08:00
draft: false
tags:
- Linux
- OpenWRT
...
description: 用了这么久，发现还是RouterOS好用，因为太高级了！RouterOS的功能非常多，OpenWRT的IPv6会卡死的问题，RouterOS都有配置可以应对。我让RouterOS作为主路由，OpenWRT作为旁路由，一个负责拨号、DHCP、策略路由、IPv6等高级功能，一个负责旁路分流和智能DNS，不影响IOT设备的稳定性同时，还能满足各种家庭网络需要。
---
...
![image-11](./image-11.webp)

![image-12](./image-12.webp)
