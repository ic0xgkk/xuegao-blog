...
- /posts/1928
- /archives/1928
- /run-k8s-pod-on-windows
categories:
- 云原生
date: 2021-09-11 09:10:21+08:00
draft: false
tags:
- Kubernetes
- Linux
...
看完了文章，我愣是没看明白它在讲啥，不愧是Windows。不过，它下边一张图倒是更清晰了一些![HNS](./hns-management-stack.webp)
...
截止到这里，我们差不多了解了Windows容器的原理了[^9]。最后，再来看看它的结构[^8]：![结构](./mt797649.brown_figure1_hires.webp)
...
![Sticker](./Snipaste_2021-09-13_21-26-41.webp)
